...
function obtenerFechaFormateada() {
  ...
  return "<span class=\"math-inline\">{dia}-</span>{mes}-".concat(año);
}
...
function obtenerHoraFormateada() {
  ...
  var horaFormateada = "<span class=\"math-inline\">{horas}:</span>{minutos}";
...
function _enviarMensaje() {
  _enviarMensaje = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(mensaje) {
    var nuevoMensaje, response, mensajeEl, editarBtn, eliminarBtn;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          mensajeEl.setAttribute('data-id', response.data.id);
          ...
          editarBtn = mensajeEl.querySelector('.editar');
          ...
          // Función del botón de eliminar y desplegable
          eliminarBtn = mensajeEl.querySelector('.eliminar');
...
function eliminarMensaje(_x2) {
  return _eliminarMensaje.apply(this, arguments);
}
function _eliminarMensaje() {
  _eliminarMensaje = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(mensajeEl) {
    var idMensaje;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          idMensaje = mensajeEl.getAttribute('data-id');
          _context2.next = 3;
          return axios["delete"]("http://localhost:3000/messages/".concat(idMensaje));
        case 3:
        case "end":
